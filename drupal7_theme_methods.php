...
$art_style = '';
$art_head = '';
function STCRec_process_html(&$variables) {
...
function STCRec_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function STCRec_button($variables) {
 ...
 */
function STCRec_preprocess_page(&$vars) {
  global $art_style, $art_head;
 ...
 * @ingroup themeable
 */
function STCRec_menu_local_task($variables) {
 ...
 */
function STCRec_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function STCRec_node_preview($variables) {
  $node = $variables['node'];
...
*/
function STCRec_form_alter(&$form, &$form_state, $form_id) {
...
function STCRec_form_element_label($variables) {
...
function STCRec_form_element($variables) {
  $element = &$variables['element'];
  // This is also used in the installer, pre-database setup.
  $t = get_t();
...
function STCRec_pager($variables) {
  $tags = $variables['tags'];
  $element = $variables['element'];
